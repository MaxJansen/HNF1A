...
setwd("/well/mccarthy/users/maxlouis/oxford2/HNF1A_project/data/sumcheck3")
...
batchSummer("Batch1/23.07.2019.Batch1.gene.counts.tsv", "Batch1.txt")
batchSummer("Batch2/23.07.2019.Batch2.gene.counts.tsv", "Batch2.txt")
batchSummer("Batch3/23.07.2019.Batch3.gene.counts.tsv", "Batch3.txt")
batchSummer("Batch4/23.07.2019.Batch4.gene.counts.tsv", "Batch4.txt")
